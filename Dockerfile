...
RUN packs="vim build-essential python-dev libffi-dev git python-pip python3-pip gdb=8.1-0ubuntu3 binutils xz-utils ruby libc6-dbg nasm lrzsz net-tools iputils-ping strace netcat" \
